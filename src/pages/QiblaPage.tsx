...
const QiblaPage = () => {
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Qibla" subtitle="القبلة" icon={<Compass className="w-6 h-6" />} />
          ...
          <>
            ...
            <div className="relative w-64 h-64">
              ...
              >
                ...
                <div className="absolute top-2 left-1/2 -translate-x-1/2 flex flex-col items-center">
                  ...
                  <span className="text-[10px] font-bold text-foreground mt-1">Kaaba</span>
                </div>
                {/* Cardinal directions */}
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {hasLocation ? `${Math.round(qiblaAngle)}° from North` : "Getting location..."}
              </p>
              <p className="text-xs text-muted-foreground mt-3 max-w-[250px]">
                Point your phone towards the Kaaba marker for accurate Qibla direction
              </p>
            </div>
          </>
        )}
