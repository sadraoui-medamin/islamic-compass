...
import { ArrowRight, Play, Pause, SkipForward, SkipBack, Volume2, Type, BookOpen, Loader2 } from "lucide-react";
...
const SurahReader = ({ surahNumber, surahName, surahNameAr, onBack }: SurahReaderProps) => {
    ...
    <div className="animate-fade-in">
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        {surahNumber !== 1 && surahNumber !== 9 && (
          <p className="font-arabic text-center text-primary text-xl py-3">
